  ...
  return (
    <div className="flex min-h-screen bg-background">
      ...
      >
        ...
        {!collapsed && (
          <div className="border-t border-border p-4">
            ...
            <Progress value={creditPct} className="h-1.5 bg-secondary [&>div]:bg-primary" />
          </div>
        )}
      ...
      <div className="flex flex-1 flex-col">
        {/* Topbar */}
        <header className="sticky top-0 z-40 flex h-16 items-center justify-end gap-4 border-b border-border bg-background/80 px-6 backdrop-blur-xl">

      ...
      <div className="page-transition w-full max-w-md">
        <div className="mb-8 text-center">
          <Link to="/" className="inline-flex items-center gap-2 mb-6">
            <div className="gradient-primary flex h-9 w-9 items-center justify-center rounded-lg font-bold text-primary-foreground">
              N
            </div>
            <span className="text-xl font-bold text-foreground">NexaFlow</span>
          </Link>
          <h1 className="text-2xl font-bold text-foreground">Welcome back</h1>
          <p className="mt-1 text-secondary">Sign in to your account</p>
        </div>
        ...
        <div className="surface-card p-6">
          ...
          <Button variant="outline" className="w-full border-border" onClick={handleGoogleLogin}>
